            ...
            <div class="col-md-12">
                <div class="card">
                    <div class="card-header">
                        ...
                        <span class="float:right"><a class="btn btn-primary btn-block btn-sm col-sm-2 float-right" href="index.php?page=add_product" id="new_product">
                                ...
                                ?>
                                    <tr data-id='<?php echo $row['id'] ?>'>
                                        ...
                                        <td class="text-center">
                                            ...
                                            <form action=<?php echo ADMINURL . 'actions.php?action=delete_product' ?> class="m-0" method="post">
                                                <input type="hidden" name="id" value="<?php echo $row['id'] ?>">
                                                <button class="btn btn-sm btn-outline-danger delete_product" type="submit">Delete</button>
                                            </form>
                                        </td>
                                    </tr>
                                <?php endwhile; ?>
